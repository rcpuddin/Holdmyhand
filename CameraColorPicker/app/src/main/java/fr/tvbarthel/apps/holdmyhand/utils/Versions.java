package fr.tvbarthel.apps.holdmyhand.utils;
...
public final class Versions {
     ...
     * @return the version name of the application or {@link fr.tvbarthel.apps.holdmyhand.utils.Versions#DEFAULT_VERSION_NAME}.
     */

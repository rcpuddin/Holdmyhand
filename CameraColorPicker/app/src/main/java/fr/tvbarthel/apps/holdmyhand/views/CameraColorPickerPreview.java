...
public class CameraColorPickerPreview extends TextureView implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
    ...
    /**
     * An {@link fr.tvbarthel.apps.holdmyhand.views.CameraColorPickerPreview.OnColorSelectedListener} that will be called each time a new color is being selected.
     */
    ...
    /**
     * Set a {@link fr.tvbarthel.apps.holdmyhand.views.CameraColorPickerPreview.OnColorSelectedListener} that will be called each time a new color is selected.
     *
     * @param onColorSelectedListener the {@link fr.tvbarthel.apps.holdmyhand.views.CameraColorPickerPreview.OnColorSelectedListener} that will be called.
     */

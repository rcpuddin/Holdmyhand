package fr.tvbarthel.apps.holdmyhand.adapters;
...
public class PaletteAdapter extends ArrayAdapter<Palette> {
    ...
    /**
     * Create a {@link View} associated with a {@link fr.tvbarthel.apps.holdmyhand.adapters.PaletteAdapter.ViewHolder}
    ...
    /**
     * Bind a {@link fr.tvbarthel.apps.holdmyhand.adapters.PaletteAdapter.ViewHolder}
     * to the {@link Palette} at the given position.
     *
     * @param viewHolder the {@link fr.tvbarthel.apps.holdmyhand.adapters.ColorItemAdapter.ViewHolder}.

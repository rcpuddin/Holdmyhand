package fr.tvbarthel.apps.holdmyhand.views;
...
import fr.tvbarthel.apps.holdmyhand.activities.ColorDetailActivity;
...
import fr.tvbarthel.apps.holdmyhand.utils.ClipDatas;

/**
 * A simple {@link FrameLayout} used in the {@link android.support.v4.view.ViewPager} of the {@link fr.tvbarthel.apps.holdmyhand.activities.MainActivity}
 * to display the list of the {@link ColorItem}s that the user created.
 */
public class ColorItemListPage extends FrameLayout {

    /**
     * A {@link ColorItemAdapter} used for adapting the {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}s.
     */
    private ColorItemAdapter mColorItemAdapter;

    /**
     * A {@link android.widget.ListView} used for displaying the {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}s
     */
    private ListView mListView;

    /**
     * A {@link fr.tvbarthel.apps.holdmyhand.data.ColorItems.OnColorItemChangeListener} for listening the creation of new {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}s.
     */
    private ColorItems.OnColorItemChangeListener mOnColorItemChangeListener;

    /**
     * The user-visible label for the clip {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}.
     */

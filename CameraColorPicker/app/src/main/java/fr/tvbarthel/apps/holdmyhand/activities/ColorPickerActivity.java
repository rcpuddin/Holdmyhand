...
import fr.tvbarthel.apps.holdmyhand.utils.Cameras;
import fr.tvbarthel.apps.holdmyhand.views.CameraColorPickerPreview;
...
public class ColorPickerActivity extends AppCompatActivity implements CameraColorPickerPreview.OnColorSelectedListener, View.OnClickListener {
     ...
     * <p/>
     * Used by {@link fr.tvbarthel.apps.holdmyhand.activities.ColorPickerActivity#mPickedColorProgressAnimator}.
     */
     ...
     * <p/>
     * Used by {@link fr.tvbarthel.apps.holdmyhand.activities.ColorPickerActivity#mSaveCompletedProgressAnimator}.
     */
    ...
    /**
     * The {@link fr.tvbarthel.apps.holdmyhand.views.CameraColorPickerPreview} used for the preview.
     */
    protected CameraColorPickerPreview mCameraPreview;

    /**
     * A reference to the {@link fr.tvbarthel.apps.holdmyhand.activities.ColorPickerActivity.CameraAsyncTask} that gets the {@link android.hardware.Camera}.
     */
    ...
    protected View mPointerRingLeft;
    protected View mPointerRingRight;
    ...
    public void onColorSelected(int color) {
        ...
        mPointerRingLeft.getBackground().setColorFilter(color, PorterDuff.Mode.SRC_ATOP);
        mPointerRingRight.getBackground().setColorFilter(color, PorterDuff.Mode.SRC_ATOP);
    }
    ...
    protected void initViews() {
        ...
        mPointerRingLeft = findViewById(R.id.activity_color_picker_pointer_ring_left);
        mPointerRingRight = findViewById(R.id.activity_color_picker_pointer_ring_right);

...
import fr.tvbarthel.apps.holdmyhand.fragments.AboutDialogFragment;
import fr.tvbarthel.apps.holdmyhand.views.ColorItemListPage;
import fr.tvbarthel.apps.holdmyhand.views.PaletteListPage;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    /**
     * A {@link com.melnykov.fab.FloatingActionButton} for launching the {@link fr.tvbarthel.apps.holdmyhand.activities.ColorPickerActivity}.
     */
     ...
     * <p/>
     * {@link fr.tvbarthel.apps.holdmyhand.activities.MainActivity.PageId}
            ...
            case R.id.activity_main_fab:
                if (mCurrentPageId == PAGE_ID_COLOR_ITEM_LIST) {
                    ...
                    if (ColorItems.getSavedColorItems(this).size() <= 1) {
                        ...
                        final Intent intentColorPaletteActivity = new Intent(this, LicenseActivity.PaletteCreationActivity.class);
     ...
     *
     * @param pageId the {@link fr.tvbarthel.apps.holdmyhand.activities.MainActivity.PageId} of the current selected page.
     */

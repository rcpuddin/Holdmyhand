package fr.tvbarthel.apps.holdmyhand.fragments;
...
import fr.tvbarthel.apps.holdmyhand.views.PaletteView;
import com.holdmyhand.holdmyhand.R;

/**
 * A simple {@link android.support.v4.app.DialogFragment} used to ask the user to confirm the deletion of a {@link fr.tvbarthel.apps.holdmyhand.data.Palette}.
 */
public class DeletePaletteDialogFragment extends DialogFragment {

    /**
     * The key used to pass the {@link fr.tvbarthel.apps.holdmyhand.data.Palette} to delete as an argument.
     */
    private static final String ARG_PALETTE = "DeletePaletteDialogFragment.Args.ARG_PALETTE";

    /**
     * Create a new instance of a {@link DeletePaletteDialogFragment} to ask the user to confirm the deletion of a {@link fr.tvbarthel.apps.holdmyhand.data.Palette}.
     *
     * @param paletteToDelete the {@link fr.tvbarthel.apps.holdmyhand.data.Palette} to delete.
    ...
    /**
     * A {@link DeletePaletteDialogFragment.Callback} used when the user confirms the deletion of a {@link fr.tvbarthel.apps.holdmyhand.data.Palette}.
     */
    ...
    public interface Callback {
        ...
        /**
         * Called when the deletion of a {@link fr.tvbarthel.apps.holdmyhand.data.Palette} has been confirmed by the user.
         *
         * @param paletteToDelete the {@link fr.tvbarthel.apps.holdmyhand.data.Palette} to delete.
         */

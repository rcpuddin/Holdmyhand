package fr.tvbarthel.apps.holdmyhand.data;
...
/**
 * Static methods for dealing with {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}s.
 */
public final class ColorItems {

    /**
     * A key for saving the {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}s of the user.
     */
    ...
    /**
     * A {@link java.lang.reflect.Type} instance of a {@link java.util.List} of {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}s.
     */
    private static final Type COLOR_ITEM_LIST_TYPE = new TypeToken<List<ColorItem>>() {
    }.getType();

    /**
     * A {@link java.util.Comparator} for sorting {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}s in chronological order of creation.
     */
    ...
    /**
     * Get the {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}s of the user.
     *
     * @param context a {@link android.content.Context}.
     * @return a {@link java.util.List} of {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}s.
     */
     ...
     * Get the {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}s of the user.
     *
     * @param sharedPreferences a {@link android.content.SharedPreferences} from which the {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}s will be retrieved.
     * @return a {@link java.util.List} of {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}s.
     */
    ...
    /**
     * Save a {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}s.
     *
     * @param context     a {@link android.content.Context}.
     * @param colorToSave the {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem} to save.
     * @return Returns true if the new {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem} was successfully written to persistent storage.
     */
    ...
    /**
     * Delete a {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}.
     *
     * @param context           a {@link android.content.Context}.
     * @param colorItemToDelete the {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem} to be deleted.
    ...
    /**
     * Register a {@link fr.tvbarthel.apps.holdmyhand.data.ColorItems.OnColorItemChangeListener}.
     * <p/>
     ...
     *
     * @param context                   a {@link android.content.Context}.
     * @param onColorItemChangeListener the {@link fr.tvbarthel.apps.holdmyhand.data.ColorItems.OnColorItemChangeListener} to register.
     */
    ...
    /**
     * Unregister a {@link fr.tvbarthel.apps.holdmyhand.data.ColorItems.OnColorItemChangeListener}.
     *
     * @param context                   a {@link android.content.Context}.
     * @param onColorItemChangeListener the {@link fr.tvbarthel.apps.holdmyhand.data.ColorItems.OnColorItemChangeListener} to unregister.
     */
    ...
    /**
     * A simple class for listening to the changes of the {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}s of the user.
     */
    public abstract static class OnColorItemChangeListener implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        /**
         * Called when the {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}s of the user have just changed.
         *
         * @param colorItems the current {@link java.util.List} of the {@link fr.tvbarthel.apps.holdmyhand.data.ColorItem}s of the user.
         */

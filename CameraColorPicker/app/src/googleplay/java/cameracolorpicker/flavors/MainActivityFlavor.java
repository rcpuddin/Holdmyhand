...
import fr.tvbarthel.apps.holdmyhand.R;
import fr.tvbarthel.apps.holdmyhand.activities.MainActivity;

/**
 * The behavior of the {@link fr.tvbarthel.apps.holdmyhand.activities.MainActivity} specific to the googleplay product flavor.
 * This class should be present in all the product flavors.
 */
public class MainActivityFlavor {

    /**
     * A {@link fr.tvbarthel.apps.holdmyhand.activities.MainActivity}.
     */
